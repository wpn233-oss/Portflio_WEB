...
export const projects: Project[] = [
  ...
  { id: 'dyson-redesign', title: 'Dyson 官网', subtitle: '戴森官网 Redesign', discipline: 'Web design', year: '2026', role: '信息架构 · Web UI', description: '以更清晰的叙事节奏重新组织官网内容，让产品技术、使用情境与购买决策自然衔接。整体视觉克制，将注意力还给产品本身。', image: 'https://images.unsplash.com/photo-1558618666-fcd25c85f82e?auto=format&fit=crop&w=1800&q=85', accent: '#76a6bd', mediaType: 'image', gallery: [], status: 'published', order: 3, updatedAt: now },
